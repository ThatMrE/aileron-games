...
/** Weji — thin WebView shell around the live PWA.
...
public class MainActivity extends Activity {
  private static final String HOME = "https://aileron.games/weji.html?source=apk";
  private WebView web;

  @Override protected void onCreate(Bundle state) {
    super.onCreate(state);
    web = new WebView(this);
    web.setBackgroundColor(Color.parseColor("#0c0705"));

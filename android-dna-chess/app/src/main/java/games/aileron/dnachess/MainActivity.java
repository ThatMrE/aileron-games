package games.aileron.dnachess;
...
/** DNA Chess — thin WebView shell around the live PWA.
 *  The board (and its offline support, via service worker) lives at
 *  aileron.games, so every fix shipped to the site reaches this app instantly. */
public class MainActivity extends Activity {
  private static final String HOME = "https://aileron.games/dna-chess.html?source=apk";
  private WebView web;

  @Override protected void onCreate(Bundle state) {
    super.onCreate(state);
    web = new WebView(this);
    web.setBackgroundColor(Color.parseColor("#cdbb90"));
